function extended_pla_scenario_lot_sizing_with_prod_recourse(initInv, uRange, folfOrigin, folfSlope, complFolfOrigin, complFolfSlope, nbSegments, backlogCost, capacity, nbProducts, demandScenarios, tBreak, gurobiEnv)
	## extended_pla_scenario_lot_sizing_with_prod_recourse(initInv, uRange, folfOrigin, folfSlope, complFolfOrigin, complFolfSlope, nbSegments, backlogCost, capacity, nbProducts, demandScenarios, tBreak, gurobiEnv)
	...
	@constraint(lotSizingModel, [k in 1:nbProducts, s in 1:nbScenarios],
		invRecourse[k, 1, s] - backorderRecourse[k, 1, s] == initInv[k, 1]  +  production[k, 1] - demandScenarios[k, 1, s])
